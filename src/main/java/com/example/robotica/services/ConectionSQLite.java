...
public class ConectionSQLite {
    public static void connect() {
        ...
        try {
            ...
            statement.execute("CREATE TABLE IF NOT EXISTS COMENTARIOS(ID INTEGER PRIMARY KEY AUTOINCREMENT,IDUSER INTEGER, CONTEUDO VARCHAR, DATA VARCHAR, PLANO VARCHAR,foreign key (IDUSER) references USUARIO (ID))");
